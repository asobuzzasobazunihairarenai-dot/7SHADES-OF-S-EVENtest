...
const CARD_DATABASE = [
    ...
    { id: 18, name: "民の道の建設", colorId: "green", type: "NORMAL", arrival: "空の5マスに山札からカードを裏向きで置く。", arrivalEffect: { action: { type: 'select_cell', count: 5, logic: 'place_deck_sequential_empty', prompt: '空のマスを5つ選択してください', noCancel: true,autoBtnText: "おまかせ" } }, hand: "相手の周囲以外の任意の2マスの裏向きカードを2枚選ぶ。それらをカードの置かれていない2マスに移動させる。このカードを捨てる。", handEffect: { action: { type: 'civil_path_hand' } } },   
